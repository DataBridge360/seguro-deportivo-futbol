...
export default function DatePicker({ value, onChange, placeholder = 'dd/mm/aaaa', hasError = false }: DatePickerProps) {
  ...
  const calendar = (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" ref={ref}>
      ...
      {/* Calendar panel */}
      <div className="relative bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl p-3 w-[280px]">
          ...
          <>
            <div className="flex items-center justify-between mb-3">
              ...
              <button type="button" onClick={nextMonth} className="p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-md transition-colors text-slate-900 dark:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><path d="m9 18 6-6-6-6" /></svg>
              </button>
            </div>
