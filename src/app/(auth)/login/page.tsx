      ...
      <div className="flex flex-col flex-1 px-6 justify-center pb-20">
        <div className="py-6">
          ...
          <p className="text-[#111518] dark:text-white/70 text-base font-normal leading-normal pt-2 px-8 text-center max-w-sm mx-auto">
            Ingresá para gestionar tus seguros y ver tu información
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2 max-w-md mx-auto w-full">
          ...
          <div className="flex flex-col items-center gap-4 mt-4">
            <div className="flex items-center w-full gap-4">
              ...
              <span className="text-[#617989] text-xs font-bold uppercase tracking-widest">Credenciales de prueba</span>
              <div className="h-[1px] bg-[#dbe1e6] dark:bg-[#344857] flex-1"></div>
            </div>

            {/* Test credentials */}
            <div className="w-full bg-white/50 dark:bg-[#1c2a35]/50 border border-[#dbe1e6] dark:border-[#344857] rounded-xl p-4 text-sm">
              <div className="grid grid-cols-2 gap-2 text-[#617989]">
                <div>admin@test.com</div>
                <div className="text-right">test</div>
                <div>productor@test.com</div>
                <div className="text-right">test</div>
                <div>club@test.com</div>
                <div className="text-right">test</div>
